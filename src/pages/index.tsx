        ...
        <div className="section">
          ...
          <div className="two-columns">
            ...
            <p>
              ...
              <b>
                for the first time there's a proposal facing the state legislature
                that could make a dent
              </b>: Senate Bill 827, or SB 827 for short. The bill would up-zone
              areas near transit to allow for mid-rise housing. More specifically,
              the measure would:
              <ul>
                <li>
            ...
            <p>
              You can find the full text of the bill{' '}
